...
then 
		...
		sed -i "s/2M/$UPLOAD_MAX_FILESIZE/" /etc/php/8.1/apache2/php.ini \
		&& sed -i "s/2M/$UPLOAD_MAX_FILESIZE/" /etc/php/8.1/cli/php.ini \
		&& sed -i "s/2M/$UPLOAD_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-development \
		&& sed -i "s/2M/$UPLOAD_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-production \
		&& sed -i "s/2M/$UPLOAD_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-production.cli \
		&& sed -i "s/2M/$UPLOAD_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-production.cli
...
if [[ -z "$POST_MAX_FILESIZE" ]]; then echo "O POST_MAX_FILESIZE nao esta definido";
		...
		sed -i "s/post_max_size = 8M/post_max_size = $POST_MAX_FILESIZE/" /etc/php/8.1/apache2/php.ini \
		&& sed -i "s/post_max_size = 8M/post_max_size = $POST_MAX_FILESIZE/" /etc/php/8.1/cli/php.ini \
		&& sed -i "s/post_max_size = 8M/post_max_size = $POST_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-development \
		&& sed -i "s/post_max_size = 8M/post_max_size = $POST_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-production \
		&& sed -i "s/post_max_size = 8M/post_max_size = $POST_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-production.cli \
		&& sed -i "s/post_max_size = 8M/post_max_size = $POST_MAX_FILESIZE/" /usr/lib/php/8.1/php.ini-production.cli
fi
